...
if __name__=='__main__':
	...
	sigmas = [0,0.5,1] #std. of gaussian blurring filter
	densities = [500,250,125]
	...
	for density in densities:
		particle_polydata_path = f'/mnt/3414B51914B4DED4/dicom/data/comparisons/seed_density_resample/{density}_inject/'
		...
		for sigma in sigmas:
			case_name = f'compare_{density}density_{sigma}sigma'
